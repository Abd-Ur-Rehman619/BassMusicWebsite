                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="#"
                                                class="breadcrumb-link">Comments
                                            </a></li>
                                    </ol>
                                </nav>
                            </div>
                                    ...
                                    <tbody>
                                        @forelse ($comments as $comment)
                                            <tr>
                                                ...
                                                <td>
                                                    <audio src="{{ asset('Admin/uploads/' . $comment->music->music) }}"
                                                ...
                                                <td>
                                                    <div class="dropdown float-right">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <form
                                                                action="{{ route('Visitor.comments.destroy', $comment->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <!-- item-->
                                                            ...
                                                            <!-- item-->
                                                            <a href="{{ route('Visitor.comments.edit', $comment->id) }}"
