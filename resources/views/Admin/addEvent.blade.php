                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('admin.events.index') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="" action="{{ route('admin.events.store') }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="title" value="{{ old('title') }}" required=""
                                                minlength="3" placeholder="Title of Event" class="form-control">
                                            @if ($errors->has('title'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="location" minlength="3" required=""
                                                value="{{ old('location') }}" placeholder=" Address of the Event"
                                                class="form-control">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Hosted by</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <select name="hosted_by" class="form-control" required>
                                                <option value="" Selected hidden> SELECT HOSTER</option>
