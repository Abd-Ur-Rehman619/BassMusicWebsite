                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    @endif
                                    <div class="col-6">
                                        <form id="" action="{{ route('admin.musics.update', $music_data->id) }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <select name="cat" id="cat" class="form-control" required>
                                                        <option value="{{ $music_data->category->Cat_ID }}" Selected
                                                            hidden>
                                                            {{ $music_data->category->Cat_title }} </option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="file" name="music" required=""
                                                    data-parsley-type="file" class="form-control">
                                                @if ($errors->has('music'))
                                                    <ul class="parsley-errors-list filled" id="parsley-id-5">
