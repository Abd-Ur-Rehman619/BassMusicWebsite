                            ...
                            <div class="col-12">
                                <div class="single-song-area mt-30 mb-30 d-flex flex-wrap align-items-end">
                                    ...
                                    <div class="song-play-area">
                                            ...
                                            <div class="row">
                                                @forelse ($likes as $like)
                                                    @if ($like->likedBy == Auth::user()->id && $like->state == 'Liked')
                                                        <form action="{{ route('Creator.likes.update', $like->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('PUT')
                                                    ...
                                                    @endif
                                                @empty
                                                    <form action="{{ route('Creator.likes.store') }}" method="post">
                                                        @csrf
                                                        <input type="hidden" name="userId"
                                                            value="{{ Auth::user()->id }}">
                                        ...
                                        <form id="showhideForm" action="{{ route('Creator.comments.store') }}"
                                            method="post">
                                            @csrf
