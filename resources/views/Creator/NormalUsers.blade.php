                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            ...
                            {{-- <a href="" class="btn btn-danger btn-xs float-right"> Deleted Users</a> --}}
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="#"
                                                class="breadcrumb-link">Visitors (Normal Users)</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="section-block">
                            <h3 class="section-title"> Visitors (Normal Users)</h3>
                        </div>
                        <div class="card">
                            <div class="p-3">
                                    ...
                                    <tbody>
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td> {{ $user->status }} </td>
                                                <td>
                                                    <form action="{{ route('Creator.changeStatus', $user->id) }}"
                                                        method="post">
                                                        @method('PUT')
                                                        @csrf
                                                ...
                                                <td>
                                                    <div class="dropdown float-right">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <!-- item-->
                                                            <a href="{{ route('Creator.deleteUser', $user->id) }}"
                                                                class="dropdown-item">Delete</a>
                                                            <!-- item-->
                                                            <a href="{{ route('Creator.editUser', $user->id) }}"
