                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                @endif
                                <div class="col-md-7">
                                    <form id="" action="{{ route('Creator.updateUser', Auth::user()->id) }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="contact_no" required=""
                                                    value="{{ Auth::user()->contact_no }}" data-parsley-type="number"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="User_type"
                                                    value="{{ Auth::user()->User_type }}" class="form-control" readonly>
                                ...
                                <div class="col-md-5">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <img src="{{ asset('Admin/user images/' . Auth::user()->profile) }}"
