                                ...
                                <div class="row">
                                    <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="text-center">
                                            <img src="../Admin/user images/man.png" alt="User Profile"
                                        ...
                                        <div class="user-avatar-info">
                                            <div class="m-b-20">
                                                ...
                                                <div class="rating-star  d-inline-block">
                                                    ...
                                                    <p class="d-inline-block text-dark">CREATOR </p>
                                                </div>
                                            </div>
                                            <div class="user-avatar-address">
                                                <p class="border-bottom pb-0">
                                                    <span class="d-xl-inline-block d-block mb-2"> <i
                                                            class="fab fa-fw fa-google mr-2 text-primary">
                                            ...
                                            <div class="user-avatar-address">
                                                <p class="border-bottom pb-0">
                                                    <span class="d-xl-inline-block d-block mb-2"> <i
                                                            class="fas fa-fw fa-map text-primary"></i>
                                            ...
                                            <div class="user-avatar-address">
                                                <p class="border-bottom pb-0">
                                                    <span class="d-xl-inline-block d-block mb-2"> <i
                                                            class="fas fa-fw fa-phone-volume text-primary"></i>
                                                        {{ Auth::user()->contact_no }}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
