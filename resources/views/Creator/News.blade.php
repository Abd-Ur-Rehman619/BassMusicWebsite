                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="#" class="breadcrumb-link">News
                                            </a></li>
                                    </ol>
                                </nav>
                            </div>
                                ...
                                <table class="table" id="example" class="table table-striped table-bordered">
                                    <thead>
                                        <tr class="border-0">
                                            ...
                                            <th class="border-0">
                                                <a href="{{ route('Creator.news.create') }}"
                                                ...
                                                <td>
                                                    <div class="dropdown float-right">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <form
                                                                action="{{ route('Creator.news.destroy', $new->News_ID) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <!-- item-->
                                                            ...
                                                            <!-- item-->
                                                            <a href="{{ route('Creator.news.edit', $new->News_ID) }}"
